...
void FreeTypeLoader::Draw(TextureRenderer*pTextureRenderer,std::string text, glm::vec2 pos, int lineSpace,int charSpace,float scale,Alignment align,glm::vec4 color)
{
	if (m_flag) return;
